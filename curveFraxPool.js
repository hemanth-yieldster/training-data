...
const rate_multiplier = 10 ** 18

const curveV2FraxPool = require("./contractABI/CurveV2Pool.json");
...
//   const amp = 10000;
  ...
  rates[1] = await base_pool_contract.methods.get_virtual_price().call({}, block_number)
  let old_balances = [];
  ...
  let xp = xp_mem(rates, old_balances);
  let A = await contract.methods.A().call({}, block_number) 
  let amp = A*A_PRECISION
